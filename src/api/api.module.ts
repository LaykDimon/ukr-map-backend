...
@Module({
  imports: [ConfigModule, TypeOrmModule.forFeature([Person, User, ImportLog, ProposedEdit])],
  controllers: [
    WikipediaController,
    SearchController,
    PersonsController,
  ...
  providers: [WikipediaService, PersonsService, SearchService, StatisticsService, ProposedEditsService, EntityResolutionService],
  exports: [WikipediaService, PersonsService, SearchService, StatisticsService, ProposedEditsService, EntityResolutionService],
})
